class DzikirAfterPray {
  //buat variable datanya
  String arabic, title, translate, arabLatin;
  //kita buat constructor
  DzikirAfterPray({
    required this.arabic,
    required this.title,
    required this.translate,
    required this.arabLatin,
  });
}
...
var listDzikirAfterPray = [
  DzikirAfterPray(
      ...
      title: 'Istighfar tiga kali',
      arabic:
          'أَسْتَغْفِرُ اللًّهَ , أَسْتَغْفِرُ اللًّهَ , أَسْتَغْفِرُ اللًّهَ',
      arabLatin: '(Astaghfirulloh, Astaghfirulloh, Astaghfirulloh)'),
  DzikirAfterPray(
      translate:
  ...
  DzikirAfterPray(
    ...
    title: 'Doa minta dzikir, syukur, ihsan',
    arabic:
