...
var dataDzikirPetang = [
  DzikirPetang(
    ...
    arti2:
        '“Allah, tidak ada ilah (yang berhak disembah) melainkan Dia, yang hidup kekal lagi terus menerus mengurus (makhluk-Nya). Dia tidak mengantuk dan tidak tidur.Kepunyaan-Nya apa yang di langit dan di bumi.'
  ...
  DzikirPetang(
    title2: 'Membaca surat Al Ikhlas, Al Falaq, An Naas',
    arab2: 'بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ'
  ...
  DzikirPetang(
      title2: 'Membaca Doa ketika petang',
      arab2:
  ...
  DzikirPetang(
      title2: 'Membaca Doa ketika pagi & petang',
      arab2:
  ...
  DzikirPetang(
    title2: 'Membaca sayyidul istighfar',
    arab2:
  ...
  DzikirPetang(
      title2: 'Membaca Doa pilihan pagi/petang',
      arab2:
  ...
  DzikirPetang(
    title2: 'Membaca Doa pilihan pagi/petang',
    arab2: 'سُبْحَانَ اللهِ وَبِحَمْدِهِ',
    arti2: 'Maha suci Allah, aku memuji-Nya.(Dibaca 100 x)',
  ),
  DzikirPetang(
    title2: 'Membaca Doa pilihan pagi/petang',
    arab2:
  ...
  DzikirPetang(
      title2: 'Membaca Doa Petang',
      arab2: 'أَعُوْذُ بِكَلِمَاتِ اللهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ',
      arti2:
